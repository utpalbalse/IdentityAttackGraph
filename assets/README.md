...
| [`risk-breakdown.png`](risk-breakdown.png) | An identity's **explainable 6-factor risk breakdown** — the gauge plus per-factor scores and the signals behind them (privilege 100, blast-radius 70, exposure 85, trust 100, usage 0, freshness 15 → composite 70) |
